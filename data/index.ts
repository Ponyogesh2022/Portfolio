...
export const workExperience = [
  ...
  },
  {
    ...
    desc: "Working as a Software Engineer with 1 year of experience, contributing to multiple projects. My responsibilities include developing and deploying web applications using React.js, improving UI/UX, and converting Figma designs into interactive interfaces. I have also worked on bug fixing, application maintenance, and collaborating with cross-functional teams to deliver end-to-end project features while ensuring quality and performance..",
    className: "md:col-span-2",
    thumbnail: "/exp2.svg",
  },
